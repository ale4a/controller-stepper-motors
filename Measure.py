...
class Measure():
    ...
    def movePositiveAxisX(self):
        ...
        if self.movingPositiveAxisY:
            self.arduino.constansMoveController("Y", 1)
    ...
    def create_widgets(self):
        ...
        self.switchAxisNegativeY.bind("<ButtonPress>", lambda event : self.on_press("Y", -1, event))
        self.switchAxisNegativeY.bind("<ButtonRelease>", lambda event : self.on_release("Y", -1, event))
        ...
        self.switchAxisPositiveY.bind("<ButtonPress>", lambda event : self.on_press("Y", 1, event))
        self.switchAxisPositiveY.bind("<ButtonRelease>", lambda event : self.on_release("Y", 1, event))
