...
from tkinter import Tk, NORMAL , DISABLED, LEFT, END, N, S, W, E
...
class CommandsConsole(Frame):
    ...
    def createWidgets(self):
        ...
        self.inputCommand = Entry(self.parent, width = 50)
        ...
        self.textCommand = Text(self.parent, state=DISABLED)
        self.textCommand.grid(row = 1, column = 0, columnspan=3)
...
class GUI(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.connectionPort = CommandsConsole(self)
